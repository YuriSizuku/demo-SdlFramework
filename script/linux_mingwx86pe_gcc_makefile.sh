...
MINGW_PATH=/d/AppExtend/msys2/mingw32
BUILD_PATH=./../build_linux_x86pe
CMAKELISTS_PATH=./../
# do not import $MINGW_PATH/i686-w64-mingw32, it will have conflict
FLAGS="-I$MINGW_PATH/include -L$MINGW_PATH/lib" 
# this is for the path on WSL2 is included windows path, exprot for seperate x64
export PATH=/usr/bin:$MINGW_PATH/bin:$MINGW_PATH/lib:$MINGW_PATH/i686-w64-mingw32/lib
cmake -B $BUILD_PATH -S $CMAKELISTS_PATH \
      ...
      #-DCMAKE_EXE_LINKER_FLAGS="-Wl,-rpath=$MINGW_PATH/lib:$MINGW_PATH/i686-w64-mingw32/lib" # no need to use -rpath hear
